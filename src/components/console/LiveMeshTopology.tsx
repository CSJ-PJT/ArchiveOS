...
function isOperationalRuntime(state?: RuntimeService) { const value = String(state?.runtimeStatus || state?.serviceStatus || "").toUpperCase(); return ["PROCESSING", "RUNNING", "WAITING", "HEALTHY", "LIVE"].includes(value); }
