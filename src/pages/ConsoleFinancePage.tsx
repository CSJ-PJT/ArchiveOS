...
function amount(value: string | number | null) { if (value == null) return "데이터 없음"; const number = Number(value); return Number.isFinite(number) ? `${number.toLocaleString()} KRW` : String(value); }
