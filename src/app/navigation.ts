...
export type CoreRoute = "dashboard" | "services" | "operations" | "finance" | "records" | "mail" | "settings";
...
export const navigationItems: NavigationItem[] = [
  ...
  { id: "mail", label: "메일", shortLabel: "메일", description: "관리자 전용 ArchiveOS 메일을 확인하고 발송합니다.", icon: "mail" },
