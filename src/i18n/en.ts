...
export const en: TranslationTable = {
  ...
  "knowledge.rag": "RAG",
  "copilot.placeholder": "Search operational knowledge or ask…",
  "copilot.search": "Ask AI",
  "copilot.questionMode": "Operational question",
  "copilot.searchMode": "Knowledge search",
  "copilot.ready": "RAG ready",
  "copilot.syncRequired": "Sync required",
  "copilot.modelUnavailable": "Model unavailable",
  "copilot.vectorUnavailable": "Vector store unavailable",
  "copilot.vaultUnavailable": "Obsidian vault unavailable",
  "copilot.degraded": "RAG needs attention",
  "copilot.unavailable": "RAG unavailable",
  "copilot.documents": "documents",
  "copilot.embedded": "embedded",
  "copilot.sync": "Sync knowledge",
  "copilot.syncing": "Syncing",
  "copilot.title": "ArchiveOS Operations Copilot",
  "copilot.question": "Question",
  "copilot.answer": "AI answer",
  "copilot.references": "References",
  "copilot.context": "Runtime context used",
  "copilot.recommendation": "Recommended action",
  "copilot.humanReview": "This is an AI suggestion and requires human review before execution.",
  "copilot.noResults": "No related operational knowledge was found.",
  "copilot.noReferences": "No operational knowledge was referenced.",
  "copilot.loading": "Checking operational knowledge.",
  "copilot.retry": "Retry",
  "copilot.cancel": "Cancel",
  "copilot.close": "Close",
  "copilot.runtimeContext": "Current runtime status is included.",
  "copilot.searchResults": "Search results",
  "copilot.error": "The RAG request could not be completed.",
  "copilot.readOnly": "Read only",
  "copilot.analyze": "Analyze",
  "copilot.suggestionApproval": "Explain why the Ledger approval queue is pending.",
  "copilot.suggestionBacklog": "What is the largest processing bottleneck and what should be checked first?",
  "copilot.suggestionBalance": "Why is the ecosystem balance PARTIAL_DATA?",
  "copilot.suggestionCorrelation": "Explain the flow and anomalies for correlationId {id}.",
  "copilot.questionApproval": "Explain why the Ledger approval queue is pending and identify related operating records.",
  "copilot.questionBacklog": "Explain the largest processing bottleneck and the review order using current runtime data and evidence.",
  "copilot.questionBalance": "Explain why the ecosystem balance status is {status} and identify related past decisions.",
  "copilot.questionCorrelation": "Explain the full processing flow and anomalies for correlationId {id}.",
  "copilot.questionNode": "Explain {name}'s current state and recent backlog causes using runtime data and evidence.",
  "copilot.questionEdge": "Explain the recent state and anomalies of the {eventType} flow from {from} to {to}.",
