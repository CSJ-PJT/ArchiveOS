...
for (const path of [
  ...
  "/api/integrations/nexus/events",
  "/api/integrations/market/summary",
  "/api/integrations/market/economy",
  "/api/integrations/market/outbox",
  "/api/integrations/market/orders",
  "/api/integrations/market/claims",
  "/api/integrations/market/returns",
  "/api/integrations/logitics/summary",
  "/api/integrations/logitics/outbox",
  "/api/integrations/logitics/routes",
  "/api/integrations/ledger/summary",
  "/api/integrations/ledger/approval-required",
  "/api/integrations/ledger/reconciliation",
