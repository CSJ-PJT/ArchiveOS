    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, SessionAuthenticationFilter sessionFilter,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/health", "/actuator/health/**", "/api/auth/login", "/api/auth/recovery/**", "/api/auth/sso/exchange", "/api/mail/webhooks/resend").permitAll()
                        ...
                        .requestMatchers("/api/auth/sso/**").authenticated()
